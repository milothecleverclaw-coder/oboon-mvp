...
def convert_markdown_to_pdf(input_file, output_file):
    ...
    # 创建完整的 HTML 文档 with Thai font support
    full_html = f"""
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <style>
        ...
        body {{
            font-family: "Noto Sans Thai", "Noto Sans CJK SC", "Garuda", sans-serif;
            font-size: 11pt;
            line-height: 1.6;
            color: #333;
...
def main():
    if len(sys.argv) < 2:
        print("用法: python3 convert-thai.py <输入.md> [输出.pdf]")
        sys.exit(1)
